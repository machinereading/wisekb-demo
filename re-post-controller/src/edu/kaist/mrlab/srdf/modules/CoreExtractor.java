...
//				JSONObject innerOBJ = (JSONObject) s.next();
				...
				JSONArray morp = (JSONArray) jsonObject.get("morp");
				JSONArray dependency = (JSONArray) jsonObject.get("dependency");
				JSONArray word = (JSONArray) jsonObject.get("word");
				JSONArray wsd = (JSONArray) jsonObject.get("WSD");
