...
public class Triple {
	...
	public void setSbj(Chunk sbj) {
		this.sbj = sbj;
	}

	public Chunk getPred() {
		return pred;
	}

	public void setPred(Chunk pred) {
		this.pred = pred;
	}
	...
	public Triple(Chunk s, Chunk p, Chunk o) {
		this.sbj = s;
		this.pred = p;
		this.obj = o;
	}
	
	public Triple(Chunk s, Chunk p, Chunk o, int position) {
		this.sbj = s;
		this.pred = p;
		this.obj = o;
		this.position = position;
